...
public class Fans extends JFrame {
	...
	public Fans(int Ax, int Bx) {
		...
		label_2.setIcon(new ImageIcon(Fans.class.getResource("/botones/icons8-modern_art.png")));
		...
		button_1.setIcon(new ImageIcon(Fans.class.getResource("/botones/icons8-collage.png")));
		...
		button_2.setIcon(new ImageIcon(Fans.class.getResource("/botones/icons8-add_image.png")));
		...
		btnIdolos.setIcon(new ImageIcon(Fans.class.getResource("/botones/icons8-leaving_queue.png")));
		...
		button_4.setIcon(new ImageIcon(Fans.class.getResource("/botones/icons8-leaderboard.png")));
		...
		button_5.setIcon(new ImageIcon(Fans.class.getResource("/botones/icons8-export.png")));
		
		final JLabel label_3 = new JLabel("", SwingConstants.CENTER);
		label_3.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				label_3.setIcon(new ImageIcon(Fans.class.getResource("/botones/icons8-left_round.png")));
			}
			public void mouseExited(MouseEvent e) {
				label_3.setIcon(new ImageIcon(Fans.class.getResource("/botones/icons8-left_circular.png")));
			}
		});
		label_3.setIcon(new ImageIcon(Fans.class.getResource("/botones/icons8-left_circular.png")));
		...
		label_4.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				label_4.setIcon(new ImageIcon(Fans.class.getResource("/botones/icons8-right_round.png")));
			}
			public void mouseExited(MouseEvent e) {
				label_4.setIcon(new ImageIcon(Fans.class.getResource("/botones/icons8-right_circular.png")));
			}
		});
		label_4.setIcon(new ImageIcon(Fans.class.getResource("/botones/icons8-right_circular.png")));
			...
			gl_customPanel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_customPanel.createSequentialGroup()
					...
					.addGroup(gl_customPanel.createParallelGroup(Alignment.LEADING)
						.addComponent(lblMisFans, GroupLayout.DEFAULT_SIZE, 363, Short.MAX_VALUE)
						.addGroup(gl_customPanel.createSequentialGroup()
		...
		gl_customPanel.setVerticalGroup(
			gl_customPanel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_customPanel.createSequentialGroup()
					.addGap(19)
					.addComponent(lblMisFans, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
					.addGap(12)
					.addGroup(gl_customPanel.createParallelGroup(Alignment.LEADING)
